...
accuracy_binary = lambda: deepcopy(
    Metric[float](
        name="Accuracy",
        key="accuracy",
...
""" ~ """
accuracy_binary_balanced = lambda: deepcopy(
    Metric[float](
...
imbalance_ratio_y = lambda: deepcopy(
    Metric[float](
...
imbalance_ratio_pred_y = lambda: deepcopy(
    Metric[float](
...
binary_classification_balanced_metrics = lambda: deepcopy(
    [
        avg_precision_macro(),
        accuracy_binary(),
        recall_binary(),
...
binary_classification_imbalanced_metrics = lambda: deepcopy(
    [
        avg_precision_macro(),
...
binary_classification_metrics_balanced_benchmarking = lambda: deepcopy(
    [
        Group[pd.Series](
            name="benchmark",
            key="benchmark",
...
binary_classification_metrics_imbalanced_benchmarking = lambda: deepcopy(
    [
        Group[pd.Series](
            name="benchmark",
            key="benchmark",
...
"""~"""
minimal_binary_classification_metrics = lambda: deepcopy(
    [accuracy_binary(), f_one_score_binary()]
)
"""~"""
multiclass_classification_metrics = lambda: deepcopy(
    [
        cross_entropy(),
        recall_macro(),
        precision_macro(),
...
"""~"""
minimal_multiclass_classification_metrics = lambda: deepcopy(
    [
        f_one_score_weighted(),
        # roc_auc_multi_weighted(),
    ]
